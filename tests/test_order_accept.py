...
from data.config import BASE_URL, ErrorOrder, ACCEPT_ORDER
...
class TestAcceptOrder:
    ...
    def test_accept_order_without_courier_id_fails(self, order_id):
        client = OrderClient(BASE_URL)
        response = client._send_request("PUT", f"{ACCEPT_ORDER}/{order_id}", params={})
    ...
    def test_accept_order_without_order_id_fails(self):
        ...
        response = client._send_request("PUT", ACCEPT_ORDER, params={"courierId": 123})
